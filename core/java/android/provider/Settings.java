...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Control which rotation angles the accelerometer can use when
         * {@link #ACCELEROMETER_ROTATION} is enabled.
         * Value is a bitwise combination of:
         * 1 = 0 degrees (portrait)
         * 2 = 90 degrees (landscape)
         * 4 = 180 degrees (inverted portrait)
         * 8 = 270 degrees (inverted landscape)
         * Default -1 means use system config (all except 180).
         * @hide
         */
        public static final String ACCELEROMETER_ROTATION_ANGLES =
       ...
       /**
        ...
        /**
         * Whether network traffic indicator is enabled.
         ...
         * 0 = both (default), 1 = up only, 2 = down only
         * @hide
         */
        public static final String NETWORK_TRAFFIC_MODE = "network_traffic_mode";

        /**
         * Whether to auto-hide network traffic indicator when inactive.
         * 0 = disabled, 1 = enabled
         * @hide
         */
        ...
        /**
         * Network traffic auto-hide threshold in KB/s.
         * @hide
         */
        public static final String NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD = "network_traffic_autohide_threshold";

        /**
         * Network traffic display units.
         * 0 = auto, 1 = KB/s, 2 = MB/s
         * @hide
         */
        public static final String NETWORK_TRAFFIC_UNITS = "network_traffic_units";

        /**
         * Network traffic refresh interval in seconds.
         * @hide
         */
        public static final String NETWORK_TRAFFIC_REFRESH_INTERVAL = "network_traffic_refresh_interval";

        /**
         * Whether to hide the network traffic arrow indicator.
         * 0 = show arrows, 1 = hide arrows
         * @hide
         */

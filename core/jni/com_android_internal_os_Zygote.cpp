...
static void ReloadBuildJavaConstant(JNIEnv* env, jclass build_class, const char* field_name,
  ...
  if (strcmp(field_signature, "I") == 0) {
    ...
    env->SetStaticLongField(build_class, fieldId,
                            jlong(strtoll(new_value.c_str(), nullptr, 0)) * long_multiplier);
  }
}
...
static void ReloadBuildJavaConstants(JNIEnv* env) {
  ...
  ReloadBuildJavaConstant(env, build_cls, "TIME", "J", "ro.build.date.utc", 1000);

...
public class NetworkTraffic extends TextView implements TunerService.Tunable,
    ...
    private static final String NETWORK_TRAFFIC_MODE =
            "benzene:" + BenzeneSettings.System.NETWORK_TRAFFIC_MODE;
    private static final String NETWORK_TRAFFIC_AUTOHIDE =
            "benzene:" + BenzeneSettings.System.NETWORK_TRAFFIC_AUTOHIDE;
    private static final String NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD =
            "benzene:" + BenzeneSettings.System.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD;
    private static final String NETWORK_TRAFFIC_UNITS =
            "benzene:" + BenzeneSettings.System.NETWORK_TRAFFIC_UNITS;
    private static final String NETWORK_TRAFFIC_REFRESH_INTERVAL =
            "benzene:" + BenzeneSettings.System.NETWORK_TRAFFIC_REFRESH_INTERVAL;
    private static final String NETWORK_TRAFFIC_HIDEARROW =
            "benzene:" + BenzeneSettings.System.NETWORK_TRAFFIC_HIDEARROW;
        ...
        switch (key) {
            case NETWORK_TRAFFIC_ENABLED:
                ...
                if (mEnabled) {
                    ...
                    // Show initial "0" immediately so everything appears at once
                    setText(formatOutput(0L));
                    setTrafficDrawable();
                    setFixedWidth();
                    // Make visible immediately (mIsActive will be properly set after first refresh)
                    mIsActive = true;
                    updateVisibility();
                }
                updateViews();

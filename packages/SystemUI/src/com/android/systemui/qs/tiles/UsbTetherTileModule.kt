...
@Module
abstract class UsbTetherTileModule {

    @Binds
    @IntoMap
    @StringKey(UsbTetherTile.TILE_SPEC)
    abstract fun bindUsbTetherTile(usbTetherTile: UsbTetherTile): QSTileImpl<*>
    ...
    companion object {
        ...
        fun provideUsbTetherTileConfig(uiEventLogger: QsEventLogger): QSTileConfig {
            val tileSpec = TileSpec.create(UsbTetherTile.TILE_SPEC)
            return QSTileConfig(
                tileSpec,

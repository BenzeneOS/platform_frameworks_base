...
/** Module for injecting CaffeineTile. */
@Module
abstract class CaffeineTileModule {

    @Binds
    @IntoMap
    @StringKey(CaffeineTile.TILE_SPEC)
    abstract fun bindCaffeineTile(caffeineTile: CaffeineTile): QSTileImpl<*>
    ...
    companion object {
        ...
        fun provideCaffeineTileConfig(uiEventLogger: QsEventLogger): QSTileConfig {
            val tileSpec = TileSpec.create(CaffeineTile.TILE_SPEC)
            return QSTileConfig(
                tileSpec,

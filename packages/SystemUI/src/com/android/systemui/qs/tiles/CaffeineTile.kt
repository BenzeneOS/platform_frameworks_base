 ...
 * Copyright (C) 2025 Amaan Qureshi
 *
...
class CaffeineTile @Inject constructor(
    ...
    companion object {
        ...
        private const val SLIDER_MAX = 120f
    }
    ...
    private var caffeineState: CaffeineState = CaffeineState.Off
    ...
    private inner class CaffeineDialogController {
        ...
        private fun updateCards(v: DialogViews, caffeineActive: Boolean) {
            ...
            updateOptionCard(v.offCard, selection == Selection.OFF, caffeineActive)
        }

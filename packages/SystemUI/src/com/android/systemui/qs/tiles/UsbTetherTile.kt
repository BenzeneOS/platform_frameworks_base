...
class UsbTetherTile @Inject constructor(
    ...
    @Volatile private var mUsbConnected = false
    @Volatile private var mUsbTetherEnabled = false
    ...
    override fun handleSetListening(listening: Boolean) {
        ...
        if (listening) {
            ...
            mContext.registerReceiver(mReceiver, filter, null, mHandler, Context.RECEIVER_NOT_EXPORTED)
        } else {
    ...
    override fun handleClick(expandable: Expandable?) {
        if (mUsbConnected) {
            try {
                ...
                Log.e("UsbTetherTile", "Failed to toggle USB tethering", e)
            }
        }
    }
    ...
    companion object {
        private const val TAG = "UsbTetherTile"

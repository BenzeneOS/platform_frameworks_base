...
public class GlobalSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_ANIMATION, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_REFRESH_RATE_CAP,
                new InclusiveIntegerRangeValidator(0, 240));
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_BLUR, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_HBM, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_AOD, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_NIGHT_MODE_OFF, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_BRIGHTNESS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_LAUNCH_BOOST, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_STANDBY, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_BACKGROUND, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_DISABLE_QUICK_DOZE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_NETWORK, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_DATA, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_VIBRATION, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_SOUNDTRIGGER, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_SENSORS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_ATTENTION, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Global.BATTERY_SAVER_ALLOW_CAMERA_ROTATE, BOOLEAN_VALIDATOR);

...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.BACK_GESTURE_INSET_SCALE_RIGHT,
                new InclusiveFloatRangeValidator(0.0f, Float.MAX_VALUE));
        VALIDATORS.put(Secure.BACK_GESTURE_REGION_LEFT_TOP_PERCENT,
                PERCENTAGE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.BACK_GESTURE_REGION_LEFT_BOTTOM_PERCENT,
                PERCENTAGE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.BACK_GESTURE_REGION_RIGHT_TOP_PERCENT,
                PERCENTAGE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.BACK_GESTURE_REGION_RIGHT_BOTTOM_PERCENT,
                PERCENTAGE_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(Secure.SCRAMBLE_SIM_PIN_LAYOUT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.REQUIRE_UNLOCK_FOR_POWER_MENU, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.DISABLE_SECURE_WINDOWS, BOOLEAN_VALIDATOR);
